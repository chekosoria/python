...
class AddEndPointAl(tk.Frame):
    """Pantalla para agregar Endpoints de Anexos por lote"""
    ...
    def __init__(self, parent, controller):
        ...
        self.logger.info(
            "Inicializando pantalla para agregar Endpoints de Anexos por lote")
        ...
        label_titulo = tk.Label(
            container, text="Agregar Endpoints de Anexos por lote",
    ...
    def cargar_endpoints(self):
        ...
        with obtener_conexion() as conn:
            cursor = conn.cursor()
            cursor.execute(
                "SELECT id, alias, url, parametros, download_url, ambiente FROM anexos_lote")
