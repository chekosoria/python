...
class EditEndPointAl(tk.Frame):
    """Pantalla editar Endpoints de Anexos por lote"""
    ...
    def __init__(self, parent, controller):
        ...
        self.logger.info(
            "Inicializando pantalla para editar Endpoints de Anexos por lote")
        ...
        label_titulo = tk.Label(
            container, text="Editar Endpoints de Anexos por lote",
