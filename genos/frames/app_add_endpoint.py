...
class AddEndPoint(tk.Frame):
    """Pantalla para agregar Endpoints"""
    ...
    def __init__(self, parent, controller):
        ...
        self.logger.info(
            "Inicializando pantalla para agregar Endpoints")
        ...
        label_titulo = tk.Label(
            container, text="Agregar Endpoints", font=("Helvetica", 24, "bold"))
                ...
                with obtener_conexion() as conn:
                    ...
                    cursor.execute(
                        """INSERT INTO endpoints
                           (alias,url,parametros,download_url)
                           VALUES (?,?,?,?)""",
                        (alias, url, params, download_url))
                    conn.commit()
                messagebox.showinfo(
