...
class BatchTest(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label_titulo = tk.Label(
            container, text="Prueba de Endpoints PROD vs QA", font=("Helvetica", 24, "bold"))
    ...
    def test_endpoints(self):
        ...
        base_dir = self.run_endpoint_test(base_alias, "_prod")
        compare_dir = self.run_endpoint_test(compare_alias, "_qa")
