...
print(lenguajes[1])
# Si se llama un elemento de la lista con un número negativo se comienza a contar los índices desde el último elemto el cuál sería -1
print(lenguajes[-1])
"""
...
print(lenguajes[1:3])
"""
Si se llama un elemento por rango y no se indica el valor inicial Python resolverá que el primer elemento
que se quiere mostrar es el primer elemento de la lista
"""
print(lenguajes[:3])
"""
Si se llama un elemento por rango y no se indica el valor final Python resolverá que el último elemento
que se quiere mostrar es el último elemento de la lista
"""
print(lenguajes[1:])